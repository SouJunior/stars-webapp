<template>
    ...
    <v-col>
      <v-card class="pa-2">
        ...
        <v-card-actions>
          <v-btn
            color="primary"
            :to="{ name: 'squad-update', params: { uuid: auth.squads[0].uuid } }"
          >
            Atualizar
          </v-btn>
          <v-spacer />
          <v-dialog width="500">
            ...
            <template #default="{ isActive }">
              <v-card title="Dialog">
                ...
                <v-card-actions>
                  <v-btn color="red" text="excluir" @click="del(auth.squads[0].uuid)"></v-btn>
                  <v-spacer />
  ...
  <v-data-table :headers="headers" :items="useMembers.member">
          ...
          <v-card title="Dialog">
            ...
            <v-card-actions>
              <v-btn
                ...
                text="excluir"
                @click="
                  delMember(item.squad_uuid, item.uuid);
